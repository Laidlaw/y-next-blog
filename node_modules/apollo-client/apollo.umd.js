...
var IntrospectionFragmentMatcher = (function () {
    ...
    IntrospectionFragmentMatcher.prototype.ensureReady = function (queryManager) {
        var _this = this;
        if (this.readyPromise) {
            return this.readyPromise;
        }
        this.readyPromise = queryManager.query({ query: query })
            .then(function (res) {
            _this.possibleTypesMap = _this.parseIntrospectionResult(res.data);
            _this.isReady = true;
            return;
        })
            .catch(function (err) {
    ...
    IntrospectionFragmentMatcher.prototype.canBypassInit = function (query$$1) {
...
var QueryManager = (function () {
    ...
    QueryManager.prototype.fetchQuery = function (queryId, options, fetchType, fetchMoreForQueryId) {
        ...
        return this.fragmentMatcher.ensureReady(this).then(function () {
            return _this.fetchQueryAfterInit(queryId, options, fetchType, fetchMoreForQueryId);
        });
    };
    ...
    QueryManager.prototype.fetchQueryAfterInit = function (queryId, options, fetchType, fetchMoreForQueryId) {
